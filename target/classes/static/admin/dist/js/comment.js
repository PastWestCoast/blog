$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '评论时间', name: 'commentCreateTime', index: 'commentCreateTime', width: 110},
            {label: '评论人名称', name: 'commentator', index: 'commentator', width: 55},
            {label: '评论人邮箱', name: 'email', index: 'email', width: 90},
            {label: '状态', name: 'commentStatus', index: 'commentStatus', width: 45, formatter: statusFormatter},
